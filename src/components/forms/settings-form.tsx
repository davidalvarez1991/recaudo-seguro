...
EL DEUDOR se compromete a pagar el préstamo en un plazo de "CUOTAS DEL CREDITO" cuota(s), a partir del día "DIA DONDE EL COBRADOR SELECIONA EL PAGO DE LA CUOTA", mediante pagos de cuotas por valor de $ "VALOR DE LA CUOTA MAS COMISION", hasta completar el capital más los intereses pactados.
